export const level8 = {
  ...
  ordenarKey: { x: 150, y: 70, width: 20, height: 20 }, // Llave ordenadora (roja)
  platforms: [
    ...
    { x: 0, y: 500, width: 80, height: 12 },
    { x: 130, y: 400, width: 80, height: 12 },
    { x: 0, y: 300, width: 80, height: 12 },
    { x: 80, y: 200, width: 80, height: 12 },
